...
object PostList {
    ...
    val postList = mutableListOf<PostInfo>(
        ...
        PostInfo(postIndex = 4, id = "test3", image = R.drawable.test2_user_post_image,  postContent = "물결 소리가 청량함과 평온을 선사하는 아침 해변, 내게는 무한한 자유로움을 상상케 해.", name = "설희ㅅ아", userImage = R.drawable.test2_user_image),
